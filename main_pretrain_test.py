...
parser.add_argument('--name', type=str, default='test7_12', help='agent name')
parser.add_argument('--Loadname', type=str, default='avoid7_12', help='loaded agent name')
...
parser.add_argument('--Max_train_steps', type=int, default=25000, help='Max training steps')
...
def main():
    ...
    for t in range(total_steps):
        ...
        current_steps += 1
        '''Interact & trian'''
        action, entropy = model.select_action(state, deterministic=True, with_logprob=True)  # a∈[-1,1]
