...
parser.add_argument('--name', type=str, default='avoid7_12t', help='agent name')
parser.add_argument('--env_with_dw', type=str2bool, default=False, help='Env with die and win, or not')
parser.add_argument('--Loadmodel', type=str2bool, default=False, help='Load pretrained model or Not')
parser.add_argument('--ModelIdex', type=int, default=27500, help='which model to load')
...
parser.add_argument('--max_e_steps', type=int, default=500, help='Max steps in an episode')
parser.add_argument('--save_interval', type=int, default=600, help='Model saving interval, in steps.')
...
def main():
    ...
    #Interaction config:
    start_steps = 4 * steps_per_epoch
    update_after = 15 * opt.batch_size
    ...
    if opt.Loadmodel:
        model.load(opt.name, opt.ModelIdex)
